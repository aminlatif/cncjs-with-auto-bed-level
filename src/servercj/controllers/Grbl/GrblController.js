...
const SerialConnection = require('../../lib/SerialConnection.js').default;
const EventTrigger = require('../../lib/EventTrigger.js');
const Feeder = require('../../lib/Feeder.js');
const { Sender, SP_TYPE_CHAR_COUNTING } = require('../../lib/Sender.js');
const { Workflow } = require('../../lib/Workflow.js');
const { WORKFLOW_STATE_IDLE } = require('../../lib/Workflow.js');
const { WORKFLOW_STATE_RUNNING } = require('../../lib/Workflow.js');
const { WORKFLOW_STATE_PAUSED } = require('../../lib/Workflow.js');
const delay = require('../../lib/delay.js');
const ensurePositiveNumber = require('../../lib/ensure-positive-number.js');
const evaluateAssignmentExpression = require('../../lib/evaluate-assignment-expression.js');
const logger = require('../../lib/logger.js').default;
const translateExpression = require('../../lib/translate-expression.js');
...
const { GLOBAL_OBJECTS } = require('../constants.js');
const { WRITE_SOURCE_CLIENT } = require('../constants.js');
const { WRITE_SOURCE_FEEDER } = require('../constants.js');
const GrblRunner = require('./GrblRunner.js');
const {
  GRBL,
...
class GrblController {
    ...
    emit(eventName, ...args) {
      Object.keys(this.sockets).forEach(id => {
        if (eventName === 'serialport:read') {
          this.serialPortReadListener(...args);
        }
