...
const TINYG_PLANNER_BUFFER_LOW_WATER_MARK = 5;
const TINYG_PLANNER_BUFFER_HIGH_WATER_MARK = 7;

// TinyG has a 254 byte serial buffer that receives raw ASCII commands.
const TINYG_SERIAL_BUFFER_LIMIT = 254;

// Machine State
// https://github.com/synthetos/g2/wiki/Status-Reports#stat-values
const TINYG_MACHINE_STATE_INITIALIZING = 0; // Machine is initializing
const TINYG_MACHINE_STATE_READY = 1; // Machine is ready for use
const TINYG_MACHINE_STATE_ALARM = 2; // Machine is in alarm state
const TINYG_MACHINE_STATE_STOP = 3; // Machine has encountered program stop
const TINYG_MACHINE_STATE_END = 4; // Machine has encountered program end
const TINYG_MACHINE_STATE_RUN = 5; // Machine is running
const TINYG_MACHINE_STATE_HOLD = 6; // Machine is holding
const TINYG_MACHINE_STATE_PROBE = 7; // Machine is in probing operation
const TINYG_MACHINE_STATE_CYCLE = 8; // Reserved for canned cycles (not used)
const TINYG_MACHINE_STATE_HOMING = 9; // Machine is in a homing cycle
const TINYG_MACHINE_STATE_JOG = 10; // Machine is in a jogging cycle
const TINYG_MACHINE_STATE_INTERLOCK = 11; // Machine is in safety interlock hold
const TINYG_MACHINE_STATE_SHUTDOWN = 12; // Machine is in shutdown state. Will not process commands
const TINYG_MACHINE_STATE_PANIC = 13; // Machine is in panic state. Needs to be physically reset

// Cycle State
const TINYG_CYCLE_STATE_OFF = 0; // cycle off (not in cycle)
const TINYG_CYCLE_STATE_NORMAL = 1; // normal machine state
const TINYG_CYCLE_STATE_PROBE = 2; // probe cycle
const TINYG_CYCLE_STATE_HOMING = 3; // homing cycle
const TINYG_CYCLE_STATE_JOG = 4; // jog cycle

// Motion State
const TINYG_MOTION_STATE_OFF = 0; // motion off
const TINYG_MOTION_STATE_RUN = 1; // motion run
const TINYG_MOTION_STATE_HOLD = 2; // motion hold

// Feedhold State
const TINYG_FEEDHOLD_STATE_OFF = 0; // feedhold off (not in feedhold)
const TINYG_FEEDHOLD_STATE_SYNC = 1; // feedhold sync phase
const TINYG_FEEDHOLD_STATE_PLANNING = 2; // feedhold planning phase
const TINYG_FEEDHOLD_STATE_DECELERATION = 3; // feedhold deceleration phase
const TINYG_FEEDHOLD_STATE_HOLDING = 4; // feedhold holding
const TINYG_FEEDHOLD_STATE_END = 5; // feedhold end hold

// G-code Motion Mode
const TINYG_GCODE_MOTION_G0 = 0;
const TINYG_GCODE_MOTION_G1 = 1;
const TINYG_GCODE_MOTION_G2 = 2;
const TINYG_GCODE_MOTION_G3 = 3;
const TINYG_GCODE_MOTION_G80 = 4;

// G-code Coordinate System
const TINYG_GCODE_COORDINATE_G53 = 0;
const TINYG_GCODE_COORDINATE_G54 = 1;
const TINYG_GCODE_COORDINATE_G55 = 2;
const TINYG_GCODE_COORDINATE_G56 = 3;
const TINYG_GCODE_COORDINATE_G57 = 4;
const TINYG_GCODE_COORDINATE_G58 = 5;
const TINYG_GCODE_COORDINATE_G59 = 6;

// G-code Plane Selection
const TINYG_GCODE_PLANE_G17 = 0;
const TINYG_GCODE_PLANE_G18 = 1;
const TINYG_GCODE_PLANE_G19 = 2;

// G-code Units
const TINYG_GCODE_UNITS_G20 = 0;
const TINYG_GCODE_UNITS_G21 = 1;

// G-code Distance Mode
const TINYG_GCODE_DISTANCE_G90 = 0;
const TINYG_GCODE_DISTANCE_G91 = 1;

// G-code Feedrate Mode
const TINYG_GCODE_FEEDRATE_G93 = 0;
const TINYG_GCODE_FEEDRATE_G94 = 1;
const TINYG_GCODE_FEEDRATE_G95 = 2;

// G-code Path Control Mode
const TINYG_GCODE_PATH_G61 = 0;
const TINYG_GCODE_PATH_G61_1 = 1;
const TINYG_GCODE_PATH_G64 = 2;

// Status Codes
// https://github.com/synthetos/g2/wiki/Status-Codes
const TINYG_STATUS_CODES = [
  {
    code: 0,
    msg: 'OK'
  },
...
module.exports = {
  ...
  TINYG_CYCLE_STATE_OFF,
  TINYG_CYCLE_STATE_NORMAL,
  TINYG_CYCLE_STATE_PROBE,
  TINYG_CYCLE_STATE_HOMING,
  TINYG_CYCLE_STATE_JOG,
  TINYG_MOTION_STATE_OFF,
  TINYG_MOTION_STATE_RUN,
  TINYG_MOTION_STATE_HOLD,
  TINYG_FEEDHOLD_STATE_OFF,
  TINYG_FEEDHOLD_STATE_SYNC,
  TINYG_FEEDHOLD_STATE_PLANNING,
  TINYG_FEEDHOLD_STATE_DECELERATION,
  TINYG_FEEDHOLD_STATE_HOLDING,
  TINYG_FEEDHOLD_STATE_END,
