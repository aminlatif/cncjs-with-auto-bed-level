...
class UpdateRecord extends Component {
      ...
      return {
        values: {
          ...
          limits: {
            ...
            availableXmin: Number(_get(values, 'limits.availableXmin')) || 0,
            availableXmax: Number(_get(values, 'limits.availableXmax')) || 0,
            availableYmin: Number(_get(values, 'limits.availableYmin')) || 0,
            availableYmax: Number(_get(values, 'limits.availableYmax')) || 0,
            availableZmin: Number(_get(values, 'limits.availableZmin')) || 0,
            availableZmax: Number(_get(values, 'limits.availableZmax')) || 0
          }
        }
      };
    }
    ...
    onSubmit = (values) => {
      ...
      updateRecord(id, updatedRecord, forceReload);
    };
